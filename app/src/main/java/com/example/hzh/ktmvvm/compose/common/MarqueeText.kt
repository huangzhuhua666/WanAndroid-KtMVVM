...
fun MarqueeText(
    ...
    LaunchedEffect(key1 = textLayoutInfoState.value) {
        ...
        val duration = 9000 * textLayoutInfo.textWidth / textLayoutInfo.containerWidth
        val delay = 1000L
    ...
    SubcomposeLayout(modifier = modifier.clipToBounds()) { constraints ->
        ...
        if (mainText.width <= constraints.maxWidth) {
            ...
            val spacing = constraints.maxWidth / 4
